...
export default function Home() {
  ...
  const tFind = useTranslations('find');
      ...
      <header className="sticky top-0 z-40 border-b bg-white">
        <div className="container flex h-20 items-center justify-between py-4">
          ...
          <div className="flex items-center gap-4">
            <Button className="bg-emineon-blue hover:bg-emineon-light text-white rounded-none px-6">{tNav('contactUs')}</Button>
          </div>
        </div>
      </header>
        ...
        <section id="get-started-section" className="py-16 bg-emineon-blue text-white scroll-mt-20">
          <div className="container">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">{tFind('title')}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/10 p-8 backdrop-blur-sm rounded-sm hover:bg-white/20 transition-all">
                <h3 className="text-2xl font-bold mb-4">{tFind('findAJob')}</h3>
                <p className="mb-6">
                  {tFind('findAJobDesc')}
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-2">
                    ...
                    <span>{tFind('findAJob1')}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-white shrink-0 mt-0.5" />
                    <span>{tFind('findAJob2')}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-white shrink-0 mt-0.5" />
                    <span>{tFind('findAJob3')}</span>
                  </li>
                </ul>
                <Button className="bg-white text-emineon-blue hover:bg-blue-50 rounded-none px-8">
                  {tFind('joinAsTalent')} <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </div>

              <div className="bg-white/10 p-8 backdrop-blur-sm rounded-sm hover:bg-white/20 transition-all">
                <h3 className="text-2xl font-bold mb-4">{tFind('hireTalent')}</h3>
                <p className="mb-6">
                  {tFind('hireTalentDesc')}
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-white shrink-0 mt-0.5" />
                    <span>{tFind('hireTalent1')}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-white shrink-0 mt-0.5" />
                    <span>{tFind('hireTalent2')}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-white shrink-0 mt-0.5" />
                    <span>{tFind('hireTalent3')}</span>
                  </li>
                </ul>
                <Button className="bg-white text-emineon-blue hover:bg-blue-50 rounded-none px-8">
                  {tFind('findTalent')} <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </div>
            </div>
          </div>
