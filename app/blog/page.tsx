      ...
      <section className="relative w-full py-24 bg-gradient-to-r from-emineon-blue via-emineon-light to-emineon-blue overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 flex flex-col items-center justify-center text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white/90 text-sm font-medium">Latest Insights</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
            Emineon <span className="text-emineon-orange">Blog</span>
          </h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Discover insights, stories, and resources on global talent, innovation, and the future of work from our team of experts.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          {posts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h2 className="text-2xl font-bold text-neutral-800 mb-4">No posts yet</h2>
              <p className="text-neutral-600">Check back soon for our latest insights and stories!</p>
            </div>
          ) : (
            <>
              {/* Featured Post */}
              {posts[0] && (
                <div className="mb-16">
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-neutral-800">Featured Article</h2>
                  </div>
              ...
              {posts.length > 1 && (
                <div>
                  <div className="flex items-center gap-2 mb-8">
                    <div className="w-1 h-8 bg-gradient-to-b from-emineon-orange to-emineon-blue rounded-full"></div>
                    <h2 className="text-2xl font-bold text-neutral-800">More Articles</h2>
                  </div>
