        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            >
              ...
              <Link 
                href={contactLink} 
                className="bg-emineon-blue hover:bg-emineon-light text-white rounded-lg px-6 py-2 font-medium transition-all duration-200 shadow-md hover:shadow-lg mt-6 w-full text-center block"
                onClick={() => setMobileMenuOpen(false)}
              >
                {contactText}
              </Link>
